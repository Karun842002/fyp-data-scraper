...
with open('D:\\FYP\\Sentence-Simplification\\cleaned1.txt', 'r') as f:
    l = f.readlines()
    paragraph = f.read()
sentences = nltk.sent_tokenize(paragraph)
print(len(sentences), len(l))

for i in range(14):
    simples = open('D:\\FYP\\Sentence-Simplification\\simples.txt', 'w')
    for sentence in tqdm.tqdm(l[i * 500:(i + 1) * 500]):
